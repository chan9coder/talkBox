...
<table width="700" cellpadding="5">
	...
	<tr>
		<td colspan="6"  valign="top"><%=fl_content %></td>
	</tr>
	<tr>
...
<input type="button" class="btn2" value="목록" onclick="location.href='tbfreeList.jsp<%=args %>';" /></td>
</table>
<%
...
function goLogin(msg){
	if(confirm(msg + " 로그인이 필요합니다. \n로그인 화면으로 이동하시겠습니까?")){
		location.href = "/talkbox/tbLoginForm.jsp?url=<%=loginUrl %>";
	}
}
...
<tr align="left" valign="top">
	...
	<% if (isLogin &&loginInfo.getMi_id().equals(rs.getString("mi_id"))) {%>
		...
		<img src="../img/modify.png" width="20" title="댓글 수정" class="hand" onclick="replyUp(<%=rs.getInt("fr_idx") %>);" />
	<%} %>
	</td> 
</tr>
<tr><td colspan="5">
