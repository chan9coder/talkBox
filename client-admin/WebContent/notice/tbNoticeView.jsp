...
<table width="800" cellpadding="5" border="1">
	<h2 style="color:lightgreen" >공지사항</h2>
	...
	<th>글 내용</th>
	<td colspan="3" height="400"><%=nl_content%></td>
	</tr>
</table>
<table>
<td width="800" align="right"><input type="button" align="right" value="목록" onclick="location.href='tbNoticeList.jsp<%=args %>'" /></td>
</table>
</div>
