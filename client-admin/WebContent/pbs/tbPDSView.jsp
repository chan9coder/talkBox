...
<table width="600" cellpadding="5" border="1">
	<h2 style="color:green" >자료실</h2>
	
	<tr>
		<th>글 제목</th>
		<td width="15%"><%=pl_title %></td>
		<th>파일명</th>
		<td width="35%"><%=pl_fname %></td>
	</tr>
	<tr>
		<th width="15%">작성일</th>
	...
	<th>글 내용</th>
	<td colspan="3"><%=pl_content%></td>
	</tr>
	
</table>
<table >
<tr ><td width="600" align="right"><input type="button" value="목록" onclick="location.href='tbPDSList.jsp<%=args %>'" /></td></tr>
</table>
</div>
