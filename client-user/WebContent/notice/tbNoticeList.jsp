		...
		<td colspan="2" align="center" >
			<form name="frmSch" >
				<!-- action과 method속성은 각각 기본값인 현재 파일과 get을 사용할 것임 -->
					...
					<input type="button" value="전체 글 보기" onclick="location.href='/talkbox/notice/tbNoticeList.jsp'">
			</form>
		</td>
	</tr>
</table>
<table width="700" border="0" cellpadding="0" cellspacing="0" id="list">
 ...
 if(rs.next()){
	 ...
	 do{
		 ...
		 title2 = "<a href ='tbNoticeView.jsp?idx="+rs.getInt("nl_idx")+"&cpage="+cpage + schargs +"'";
...
<table width="700" border="0" cellpadding="5">
	...
	<tr>
		<td width="600" align="center">
			<%
 if (rcnt > 0){
	 String link = "tbNoticeList.jsp?cpage=";
	 if (cpage == 1){
		 out.print("[처음]&nbsp;&nbsp;&nbsp;[이전]&nbsp;&nbsp;");
	 } else {
